...
lizardsNroaches-server/lizardsNroaches_server: lizardsNroaches-server/lizardsNroaches-server.c lists.o fifo.o lizardsNroaches-server/z_helpers.h auxiliar.h lizardsNroaches-server/lists.h lizardsNroaches-server/fifo.h
...
lists.o: lizardsNroaches-server/lists.c lizardsNroaches-server/lists.h
	$(CC) $(CFLAGS) -c $<

# Rule for compiling fifo.c to an object file
fifo.o: lizardsNroaches-server/fifo.c lizardsNroaches-server/fifo.h
	$(CC) $(CFLAGS) -c $<
...
lizard-client/lizard_client: lizard-client/lizard-client.c auxiliar.h
	$(CC) $(CFLAGS) -o $@ lizard-client/lizard-client.c -Iinclude -I. $(LIBS)

# Rule for display-app
display-app/display_app: display-app/display-app.c display-app/z_helpers2.h auxiliar.h
